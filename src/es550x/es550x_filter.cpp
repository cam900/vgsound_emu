...
void es550x_shared_core::es550x_filter_t::lp_exec(s32 coeff, s32 in, s32 out)
{
...
void es550x_shared_core::es550x_filter_t::hp_exec(s32 coeff, s32 in, s32 out)
{
	// Store previous filter data
	m_o[out][1] = m_o[out][0];
