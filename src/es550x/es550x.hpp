...
class es550x_shared_core
{
	...
	protected:
		...
		// Internal states
		u8 m_active = max_voices() - 1;	  // Activated voices
										  // -1, ~25 for ES5504,
		...
		clock_pulse_t<s8, 2, 1> m_cas;	  // /CAS clock (CLKIN / 4), falling edge of
										  // CLKIN trigger this clock
		clock_pulse_t<s8, 4, 0> m_e;	  // E clock (CLKIN / 8),
